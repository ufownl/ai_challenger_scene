...
template <typename SUBNET> using level2 = repeat<22, res1024, res_down<1024,2,SUBNET>>;
template <typename SUBNET> using level3 = repeat<3, res512, res_down<512,2,SUBNET>>;
...
template <typename SUBNET> using alevel2 = repeat<22, ares1024, ares_down<1024,2,SUBNET>>;
template <typename SUBNET> using alevel3 = repeat<3, ares512, ares_down<512,2,SUBNET>>;
